...
Please visit [this repository](https://github.com/zongyi-li/fourier_neural_operator) to access the official PyTorch implementation of FNO from the paper's authors, and for the citation policy in case you use FNO in your research.
